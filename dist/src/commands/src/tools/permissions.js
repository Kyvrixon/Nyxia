...
export default async (client, interaction) => {
    try {
        const clientMember = (await interaction.guild.members.cache.get("1309736362454421505")) ||
        ...
        interaction.reply({
            content: null,
            embeds: [
                errEmbed("Something went wrong when executing this command", err, interaction, "Hmm..."),
            ],
        });
    }
};
