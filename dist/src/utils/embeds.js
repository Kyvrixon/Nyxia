...
export const errEmbed = (message, e, s, title = "Oops.. something went wrong") => {
    ...
    async function sendLog(error, source) {
        ...
        const logChannel = client.channels.cache.get("1322722379113300018") ||
 ...
 */
export const basicEmbed = (title, description, fields, colour, author, footerText, timestamp, thumbnail, image) => new EmbedBuilder()
